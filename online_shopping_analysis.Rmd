...
The Online Shoppers Purchasing Intention Dataset from the UCI Machine Learning Repository, has 12,330 data points and consists of both numerical and categorical attributes. The models I have used here include logistical regression, support vector machines, k-nearest-neighbour, which help to detect online shoppers purchasing patterns and forcast their intention. The outline of the analysis is as follows:
